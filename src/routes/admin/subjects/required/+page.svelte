...
<Modal open={showCreateModal} close={() => showCreateModal = false}>
    ...
    <form class="edit-form" on:submit|preventDefault={createSubject}>
        ...
        <label>必要出席日数</label>
        <input type="number" bind:value={form.required_attendance} required />
...
<Modal open={showEditModal} close={() => showEditModal = false}>
    {#if editForm}
        ...
        <form class="edit-form" on:submit|preventDefault={updateSubject}>
            ...
            <label>単位数</label>
            <input type="number" bind:value={editForm.credits} required />

            <label>必要出席日数</label>
            <input type="number" bind:value={editForm.required_attendance} required />
